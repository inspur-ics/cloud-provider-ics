...
// GetCredential returns credentials for the given iCenter Server.
...
// GetCredential returns the iCenter credentials from a Kubernetes secret
// for the provided iCenter.
